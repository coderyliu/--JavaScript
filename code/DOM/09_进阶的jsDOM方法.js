...
// document.body.clientHeight--整个body部分的高度，可视区域,不包括body的margin,border 以及滚动条, 包括padding
// document.body.offsetHeight--整个body部分的高度，可视区域,包括body的padding、border以及滚动条
...
// offsetHeight/offsetWidth---视口：包括内边距、border、滚动条，不包括margin
// clientHeight/clientWidth---视口：不包括margin、border，包括：padding
// scrollWidth/scrollHeight---全部：包括内容超出盒子的真实宽度和高度
